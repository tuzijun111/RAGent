const __vite__fileDeps=["./PlotlyPlot.B_I_IhSH.js","./2.D-u4wcY2.js","./preload-helper.DpQnamwV.js","./stores.Dl2JHwPD.js","./client.CTJnzAQC.js","../assets/2.m2NviYuI.css","./BokehPlot.Dd2N6NIe.js","../assets/BokehPlot.DX04T7W4.css","./AltairPlot.BSJyEeg-.js","./color.C8o8X0ga.js","./vega-tooltip.module.BJn3xPsZ.js","./dsv.CKxpOsHB.js","../assets/AltairPlot.O7q90H0e.css","./MatplotlibPlot.m3Jijthl.js","../assets/MatplotlibPlot.BHPTlvkw.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./preload-helper.DpQnamwV.js";
import { SvelteComponent, init, safe_not_equal, svg_element, claim_svg_element, children, detach, attr, insert_hydration, append_hydration, noop, empty, group_outros, transition_out, check_outros, transition_in, createEventDispatcher, bubble, create_component, claim_component, mount_component, destroy_component, construct_svelte_component, binding_callbacks, bind, add_flush_callback } from "../../../svelte/svelte.js";
import "../../../svelte/svelte-submodules.js";
import "./2.D-u4wcY2.js";
import { E as Empty } from "./Empty.BlIxpI4b.js";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty & /*key*/
      4096 && safe_not_equal(previous_key, previous_key = /*key*/
      ctx2[12])) {
        group_outros();
...
function create_key_block(ctx) {
  let switch_instance;
  let updating_loaded_plotly_css;
  let switch_instance_anchor;
  let current;
  function switch_instance_loaded_plotly_css_binding(value) {
    ctx[16](value);
  }
  var switch_value = (
    /*PlotComponent*/
  ...
  function switch_props(ctx2, dirty) {
    ...
    if (
      ...
      switch_instance_props.loaded_plotly_css = /*loaded_plotly_css*/
      ctx2[11];
    }
  ...
  if (switch_value) {
    ...
    binding_callbacks.push(() => bind(switch_instance, "loaded_plotly_css", switch_instance_loaded_plotly_css_binding));
    switch_instance.$on(
      "load",
      /*load_handler*/
      ctx[17]
    ...
    p(ctx2, dirty) {
      ...
      ctx2[10])) {
        ...
        256)
          ...
          ctx2[8];
        if (!updating_loaded_plotly_css && dirty & /*loaded_plotly_css*/
        2048) {
          updating_loaded_plotly_css = true;
          switch_instance_changes.loaded_plotly_css = /*loaded_plotly_css*/
          ctx2[11];
          add_flush_callback(() => updating_loaded_plotly_css = false);
        }
...
function instance($$self, $$props, $$invalidate) {
  ...
  const plotTypeMapping = {
    plotly: () => __vitePreload(() => import("./PlotlyPlot.B_I_IhSH.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url),
    bokeh: () => __vitePreload(() => import("./BokehPlot.Dd2N6NIe.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url),
    altair: () => __vitePreload(() => import("./AltairPlot.BSJyEeg-.js"), true ? __vite__mapDeps([8,1,2,3,4,5,9,10,11,12]) : void 0, import.meta.url),
  ...
  let key = 0;
  function switch_instance_loaded_plotly_css_binding(value2) {
    loaded_plotly_css = value2;
    $$invalidate(11, loaded_plotly_css);
  }
        ...
        if (type && type in plotTypeMapping && is_browser) {
          if (loadedPlotTypeMapping[type]) {
            ...
            plotTypeMapping[type]().then((module) => {
              ...
              $$invalidate(15, loadedPlotTypeMapping[type] = PlotComponent, loadedPlotTypeMapping);
            });
          }
        }
        $$invalidate(13, _value = value);
        $$invalidate(14, _type = type);
        dispatch("change");
      }
    }
  };
  return [
    ...
    switch_instance_loaded_plotly_css_binding,
    load_handler,
    select_handler
  ];
}
