import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-1WRCSaMf.js';
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-CNt3iU8Z.js';
import Example from './Example6-DQkp2AAk.js';
...
const lang_map = {
  python: () => import('./index29-DJEbTUA5.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-CL9TY5jH.js'),
      import('./frontmatter-BqiLn659.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-C3sUo0p7.js').then((m) => m.json()),
  html: () => import('./index31-DUCYoiUN.js').then((m) => m.html()),
  css: () => import('./index32-C6VBmAcw.js').then((m) => m.css()),
  javascript: () => import('./index33-CQ3YNoah.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-CQ3YNoah.js').then(
...
//# sourceMappingURL=Index13-2MkbfNCH.js.map
