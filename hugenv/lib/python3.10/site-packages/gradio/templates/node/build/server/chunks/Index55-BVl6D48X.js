import { B as Block, S as Static, f as BlockLabel, ac as TextHighlight, h as Empty, ad as globals, ae as colors } from './2-CNt3iU8Z.js';
import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, f as each, b as add_attribute, e as escape, d as add_styles, h as merge_ssr_styles } from './ssr-1WRCSaMf.js';
import { g as get_next_color } from './color-BIr8KM-b.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${label && show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: gradio.autoscroll }, loading_status, { i18n: gradio.i18n }), {}, {})} ${label && show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
            ...
            {}
          )}` : `${validate_component(Empty, "Empty").$$render($$result, { size: "small", unpadded_box: true }, {}, {
            default: () => {
              return `${validate_component(TextHighlight, "TextHighlight").$$render($$result, {}, {}, {})}`;
            }
          })}`}`;
...
//# sourceMappingURL=Index55-BVl6D48X.js.map
