...
import { R as format_time, I as IconButton, t as prepare_files, u as uploadToHuggingFace } from "./2.D-u4wcY2.js";
...
import { b as loadFfmpeg, t as trimVideo, V as Video } from "./Video.D1n7XIxM.js";
/* empty css                                              */
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*time*/
    16384) {
      $$invalidate(14, time = time || 0);
    }
    if ($$self.$$.dirty[0] & /*duration*/
    32768) {
      $$invalidate(15, duration = duration || 0);
    }
  };
  return [
    src,
