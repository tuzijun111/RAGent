var _a;
import { h as has, i as isNumber, a as isString, w as writeConfig, s as splitAccessPath, $, b as isObject, c as isBoolean$1, d as isArray, e as array, l as logger, W as Warn, f as isFunction, m as mergeConfig, g as eventSelector, j as identity, p as parser, v as vegaImport, k as e, n as applyPatch, o as expression$1, H as Handler, q as stringify$1 } from "./vega-tooltip.module.BJn3xPsZ.js";
const name$2 = "vega-lite";
const author$2 = 'Dominik Moritz, Kanit "Ham" Wongsuphasawat, Arvind Satyanarayan, Jeffrey Heer';
const version$4 = "5.17.0";
const collaborators = [
...
const homepage$1 = "https://vega.github.io/vega-lite/";
const description$3 = "Vega-Lite is a concise high-level language for interactive visualization.";
const keywords$2 = [
  "vega",
  "chart",
  "visualization"
];
const main$3 = "build/vega-lite.js";
const unpkg$2 = "build/vega-lite.min.js";
const jsdelivr$2 = "build/vega-lite.min.js";
const module$2 = "build/src/index";
const types$2 = "build/src/index.d.ts";
const bin = {
  vl2pdf: "./bin/vl2pdf",
  vl2png: "./bin/vl2png",
  vl2svg: "./bin/vl2svg",
...
function positionAndSize(fieldDef, channel, model) {
  ...
  const bandSize = getBandSize({
    ...
    markDef,
    config,
    scaleType: (_a2 = scale || offsetScale) == null ? void 0 : _a2.get("type"),
    useVlSizeChannel
  });
