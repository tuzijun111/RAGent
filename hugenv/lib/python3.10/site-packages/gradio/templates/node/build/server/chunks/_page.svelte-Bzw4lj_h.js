import { c as create_ssr_component, s as subscribe, a as createEventDispatcher, o as onDestroy, b as add_attribute, v as validate_component, m as missing_component } from './ssr-1WRCSaMf.js';
import { $ as $format, s as setupi18n, e as browser, E as Embed } from './2-CNt3iU8Z.js';
import { w as writable } from './index-BzvnFJlw.js';
import { p as page } from './stores-DTx1qMUM.js';
import 'tty';
import 'path';
import 'url';
import 'fs';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-1ilxmzf_START --><link rel="stylesheet"${add_attribute("href", "./theme.css?v=" + config?.theme_hash, 0)}><link rel="manifest" href="/manifest.json">${config.head ? `<!-- HTML_TAG_START -->${config.head}<!-- HTML_TAG_END -->` : ``}<!-- HEAD_svelte-1ilxmzf_END -->`, ""} ${validate_component(Embed, "Embed").$$render(
      $$result,
      {
...
//# sourceMappingURL=_page.svelte-Bzw4lj_h.js.map
