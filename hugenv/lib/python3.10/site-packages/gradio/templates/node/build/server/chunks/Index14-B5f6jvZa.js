import { c as create_ssr_component, v as validate_component, b as add_attribute, f as each, e as escape } from './ssr-1WRCSaMf.js';
import { r as resolve_wasm_src, B as Block, S as Static, f as BlockLabel, g as Image, h as Empty, i as IconButtonWrapper, F as FullscreenButton } from './2-CNt3iU8Z.js';
    ...
    {},
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          default: () => {
            return `${show_fullscreen_button ? `${validate_component(FullscreenButton, "FullscreenButton").$$render($$result, { container: image_container }, {}, {})}` : ``}`;
          }
        })} <img class="${[
...
//# sourceMappingURL=Index14-B5f6jvZa.js.map
