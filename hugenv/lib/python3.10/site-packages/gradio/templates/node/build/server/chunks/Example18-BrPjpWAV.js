import { c as create_ssr_component, b as add_attribute, e as escape, f as each, v as validate_component } from './ssr-1WRCSaMf.js';
import { w as Image } from './2-CNt3iU8Z.js';
...
const Example = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    ...
    return `${file.mime_type && file.mime_type.includes("image") ? `${validate_component(Image, "Image").$$render($$result, { src: file.url, alt: "" }, {}, {})}` : `${file.mime_type && file.mime_type.includes("video") ? `${validate_component(Video, "Video").$$render(
      $$result,
      {
        src: file.url,
        alt: "",
...
//# sourceMappingURL=Example18-BrPjpWAV.js.map
