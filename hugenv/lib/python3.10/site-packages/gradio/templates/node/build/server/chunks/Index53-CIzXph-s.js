import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-1WRCSaMf.js';
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-CNt3iU8Z.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-7REdIEqm.js';
export { default as BaseExample } from './Example17-CuIt77lh.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CJALcv75.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-ChESS8HU.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-CIzXph-s.js.map
