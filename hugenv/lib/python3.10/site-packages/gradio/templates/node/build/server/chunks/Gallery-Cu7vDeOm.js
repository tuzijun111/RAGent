...
import { c as create_ssr_component, a as createEventDispatcher, v as validate_component, b as add_attribute, e as escape, f as each } from './ssr-1WRCSaMf.js';
import { f as BlockLabel, g as Image, h as Empty, i as IconButtonWrapper, j as IconButton, k as Download, F as FullscreenButton, n as ShareButton, H as Clear, w as Image$1, u as uploadToHuggingFace, a1 as Play } from './2-CNt3iU8Z.js';
import { M as ModifyUpload } from './ModifyUpload-7REdIEqm.js';
import { V as Video } from './Video-xYXgTm81.js';
    ...
    {},
    {
      default: () => {
        return `${show_download_button ? `${validate_component(IconButton, "IconButton").$$render(
          ...
          {},
          {}
        )}` : ``} ${show_fullscreen_button ? `${validate_component(FullscreenButton, "FullscreenButton").$$render($$result, { container: image_container }, {}, {})}` : ``} ${show_share_button ? `<div class="icon-button">${validate_component(ShareButton, "ShareButton").$$render(
          $$result,
          {
            i18n,
            value: resolved_value,
...
//# sourceMappingURL=Gallery-Cu7vDeOm.js.map
