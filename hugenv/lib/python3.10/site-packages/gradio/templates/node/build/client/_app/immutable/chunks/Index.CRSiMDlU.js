...
import { M as MarkdownCode, H as css_units, J as copy, I as IconButton, K as Check, N as Copy, B as Block, S as Static } from "./2.D-u4wcY2.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.gLWoIi_5.js";
import { default as default2 } from "./Example.CawAdCFF.js";
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      ...
      (((_a = ctx[0]) == null ? void 0 : _a.join(" ")) || "") + " svelte-lag733");
      ...
      set_style(
        ...
        ((_b = ctx[12]) == null ? void 0 : _b.status) !== "pending" ? css_units(
          /*min_height*/
          ctx[3]
        ) : void 0
      );
    ...
    p(ctx2, [dirty]) {
      ...
      (((_a = ctx2[0]) == null ? void 0 : _a.join(" ")) || "") + " svelte-lag733")) {
      ...
      4616 || style_changed) {
        set_style(
          ...
          ((_b = ctx2[12]) == null ? void 0 : _b.status) !== "pending" ? css_units(
            /*min_height*/
            ctx2[3]
          ) : void 0
        );
