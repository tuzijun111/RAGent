...
function create_else_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*image_container, is_full_screen, show_fullscreen_button*/
      409600 | dirty[1] & /*$$scope*/
      32) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const fullscreenchange_handler = (e) => $$invalidate(18, is_full_screen = e.detail);
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      image_container = $$value;
      $$invalidate(17, image_container);
    });
  }
    ...
    29360136) {
      {
        ...
        if (value) {
          ...
          $$invalidate(24, latest_promise = current_promise);
