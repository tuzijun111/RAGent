const __vite__fileDeps=["./vega-embed.module.Cdb52ElK.js","./vega-tooltip.module.BJn3xPsZ.js","./2.D-u4wcY2.js","./preload-helper.DpQnamwV.js","./stores.Dl2JHwPD.js","./client.CTJnzAQC.js","../assets/2.m2NviYuI.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, q as BlockTitle, S as Static } from "./2.D-u4wcY2.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.Cdb52ElK.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0, import.meta.url)).default;
    }
      ...
      if (_selectable) {
        view.addSignalListener("brush", function(_, value2) {
          ...
          if (mouse_down_on_chart) {
            $$invalidate(38, release_callback = callback);
          } else {
  ...
  $$self.$$.update = () => {
    ...
    32769) {
      $$invalidate(39, x_temporal = value && value.datatypes[x] === "temporal");
    }
    ...
    8192) {
      $$invalidate(40, computed_style = chart_element ? window.getComputedStyle(chart_element) : null);
    }
    if ($$self.$$.dirty[0] & /*chart_element*/
    8192 | $$self.$$.dirty[1] & /*mounted, release_callback*/
    192) {
      if (mounted && chart_element) {
        ...
        chart_element.addEventListener("mouseup", () => {
          ...
          if (release_callback) {
            release_callback();
            $$invalidate(38, release_callback = null);
          }
        });
      }
    }
