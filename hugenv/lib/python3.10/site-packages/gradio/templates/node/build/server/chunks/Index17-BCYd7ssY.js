import { c as create_ssr_component, v as validate_component, e as escape, f as each, m as missing_component, n as null_to_empty } from './ssr-1WRCSaMf.js';
import { B as Block, X as Example } from './2-CNt3iU8Z.js';
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {},
    {
      default: () => {
        ...
        })}</div>` : `${selected_samples.length > 0 ? `<div class="table-wrap svelte-p5q82i"><table tabindex="0" role="grid" class="svelte-p5q82i"><thead><tr class="tr-head svelte-p5q82i">${each(headers, (header) => {
...
//# sourceMappingURL=Index17-BCYd7ssY.js.map
