import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, n as null_to_empty, b as add_attribute, f as each, d as add_styles, o as onDestroy, m as missing_component } from './ssr-1WRCSaMf.js';
import { B as Block, S as Static, f as BlockLabel, C as Chat, i as IconButtonWrapper, j as IconButton, t as Community, v as Trash, w as Image, x as MarkdownCode, M as Music, y as File$1, z as Copy, A as ScrollDownArrow, G as Check, H as Clear, R as Retry, J as Undo, K as Edit, N as DropdownCircularArrow } from './2-CNt3iU8Z.js';
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-pcjl1g">${validate_component(Image, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
...
const Pending = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container svelte-1u5aj92">${avatar_images[1] !== null ? `<div class="avatar-container svelte-1u5aj92">${validate_component(Image, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
...
//# sourceMappingURL=Index58-C7mapQwl.js.map
