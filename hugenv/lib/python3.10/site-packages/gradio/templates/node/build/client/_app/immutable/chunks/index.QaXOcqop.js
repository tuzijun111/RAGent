...
import { U as Upload } from "./Upload.Cj45x9Rd.js";
import { B as Block, S as Static } from "./2.D-u4wcY2.js";
import { B as BlockLabel } from "./BlockLabel.BRwM3yCt.js";
import { V as Video$1 } from "./Video.CzEOFOtQ.js";
import { S as SelectSource } from "./SelectSource.CJybP3Hp.js";
import { W as Webcam } from "./ImageUploader.m_xUK4ve.js";
/* empty css                                               */
import { p as prettyBytes, a as playable } from "./Video.D1n7XIxM.js";
import { l } from "./Video.D1n7XIxM.js";
import { P as Player, V as VideoPreview } from "./VideoPreview.CFb8JKGR.js";
import { default as default2 } from "./Example.PMP5sx02.js";
import { U as UploadText } from "./UploadText.Do69Lzuw.js";
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  function handle_change(video) {
    $$invalidate(20, has_change_history = true);
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("webcam_constraints" in $$props2)
      $$invalidate(18, webcam_constraints = $$props2.webcam_constraints);
    if ("$$scope" in $$props2)
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty[0] & /*_video, _subtitle, label, show_label, show_download_button, sources, active_source, mirror_webcam, include_audio, autoplay, root, loop, webcam_constraints, gradio, uploading, dragging, loading_status*/
      267815394 | dirty[1] & /*$$scope*/
      16777216) {
...
function create_default_slot_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      262146 ? get_spread_update(statustracker_spread_levels, [
        dirty[0] & /*gradio*/
        262144 && {
          autoscroll: (
            /*gradio*/
      ...
      if (dirty[0] & /*webcam_constraints*/
      2048)
        video_changes.webcam_constraints = /*webcam_constraints*/
        ctx2[11];
      if (dirty[0] & /*gradio*/
      262144)
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("webcam_constraints" in $$props2)
      $$invalidate(11, webcam_constraints = $$props2.webcam_constraints);
    ...
    if ("autoplay" in $$props2)
      $$invalidate(15, autoplay = $$props2.autoplay);
    if ("show_share_button" in $$props2)
      $$invalidate(16, show_share_button = $$props2.show_share_button);
    if ("show_download_button" in $$props2)
      $$invalidate(17, show_download_button = $$props2.show_download_button);
    if ("gradio" in $$props2)
      $$invalidate(18, gradio = $$props2.gradio);
    if ("interactive" in $$props2)
      $$invalidate(19, interactive = $$props2.interactive);
    if ("mirror_webcam" in $$props2)
      $$invalidate(20, mirror_webcam = $$props2.mirror_webcam);
    if ("include_audio" in $$props2)
      $$invalidate(21, include_audio = $$props2.include_audio);
    if ("loop" in $$props2)
      $$invalidate(22, loop = $$props2.loop);
    if ("input_ready" in $$props2)
      $$invalidate(31, input_ready = $$props2.input_ready);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*uploading*/
    8388608) {
      $$invalidate(31, input_ready = !uploading);
    }
    if ($$self.$$.dirty[0] & /*value*/
    1 | $$self.$$.dirty[1] & /*initial_value*/
    4) {
      if (value && initial_value === null) {
        $$invalidate(33, initial_value = value);
      }
    }
    if ($$self.$$.dirty[0] & /*sources, active_source*/
    16777280) {
      if (sources && !active_source) {
        $$invalidate(24, active_source = sources[0]);
      }
    }
    if ($$self.$$.dirty[0] & /*value*/
    1) {
      {
        if (value != null) {
          $$invalidate(25, _video = value.video);
          $$invalidate(26, _subtitle = value.subtitles);
        } else {
          $$invalidate(25, _video = null);
          $$invalidate(26, _subtitle = null);
        }
      }
    }
    if ($$self.$$.dirty[0] & /*value, gradio*/
    262145 | $$self.$$.dirty[1] & /*old_value*/
    2) {
      {
  ...
  constructor(options) {
    ...
    init(
      ...
      safe_not_equal,
      {
        ...
        height: 9,
        width: 10,
        webcam_constraints: 11,
        container: 12,
        scale: 13,
        min_width: 14,
        autoplay: 15,
        show_share_button: 16,
        show_download_button: 17,
        gradio: 18,
        interactive: 19,
        mirror_webcam: 20,
        include_audio: 21,
