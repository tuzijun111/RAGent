...
function tooltipData(encoding, stack2, config, { reactiveGeom } = {}) {
  ...
  function add2(fDef, channel) {
    ...
    const key = array$6(title2).join(", ").replaceAll(/"/g, '\\"');
    let value;
    if (isXorY(channel)) {
      const channel2 = channel === "x" ? "x2" : "y2";
...
//# sourceMappingURL=vega-embed.module-6hZUR6d3.js.map
